...
./configure \
	...
	--with-cflags="-Daix6=aix6 -D_ALL_SOURCE -D_ANSI_C_SOURCE -D_POSIX_SOURCE -qmaxmem=16384 -qnoansialias -DUSE_NATIVE_DLOPEN -DNEED_PTHREAD_INIT -D_LARGE_FILES -qlonglong -q32 -I/usr/opt/perl5/lib/5.8.8/aix-thread-multi/CORE -I/opt/freeware/lib" \
        --libdir="/usr/opt/perl5/lib/5.8.8/aix-thread-multi/CORE" \
...
then
%__ln_s /usr/opt/perl5/lib/5.8.8/aix-thread-multi/CORE/libperl.a $RPM_INSTALL_PREFIX/lib/libperl.a
fi
